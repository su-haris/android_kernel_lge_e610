...
//[s] 2013-03-14 (woden.lee@lge.com) => The OP mode of M4 on GP2AP sensor is PROX_OPMODE_B
	else	/* PROX_OPMODE_B */
	{
		if (onoff) {
...
//[e] 2013-03-14 (woden.lee@lge.com) => The OP mode of M4 on GP2AP sensor is PROX_OPMODE_B
 	return rc;
}
